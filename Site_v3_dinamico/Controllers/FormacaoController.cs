...
namespace Site_v3_dinamico.Controllers
{
    ...
    {
        private readonly FormacaoContext _context;

        public FormacaoController(FormacaoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,nomeInstituicao,dataIniciodataFim,nomeCurso,conteudos")] Formacao formacao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nomeInstituicao,dataIniciodataFim,nomeCurso,conteudos")] Formacao formacao)
        {
            if (id != formacao.Id)
            {
                return NotFound();
