...
{
    public class Encomendas1Controller : Controller
    {
        private readonly SiteDinamicoBdContext _context;

        public Encomendas1Controller(SiteDinamicoBdContext context)
        {
            _context = context;
        }
